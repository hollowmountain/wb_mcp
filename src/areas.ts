...
export const AREA_LABELS: Record<Area, string> = {
    ...
    media: 'генерация картинок и видео'
};
...
export const AREA_NOTES: Partial<Record<Area, string>> = {
    ...
    media:
        'Тратит настоящие деньги: каждая генерация списывается со счёта Higgsfield. ' +
        'Поэтому по умолчанию закрыта, а дорогие запуски требуют подтверждения.'
};
