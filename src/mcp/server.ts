...
4. Промт составляете ВЫ САМИ, по-английски и подробно: сохранить форму,
...
5. media_plan — считает цену и возвращает план. ПОКАЖИТЕ ЧЕЛОВЕКУ промт и
   цену целиком и дождитесь прямого согласия. «Наверное», «давай посмотрим»
   и молчание согласием не являются.
6. Только после «да» — media_generate с планом. Потом media_result.

Честно предупреждайте о пределе: даже с хорошим образцом модель часто портит
мелкий текст на упаковке и меняет форму деталей. Для карточки, где виден
настоящий товар, результат обычно требует доработки руками. Лучше всего
выходят фоны, настроенческие кадры и оживление готового фото в ролик.
